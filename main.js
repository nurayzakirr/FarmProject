...
var swiper = new Swiper('.swiper', {
    slidesPerView: 3, // Normal ekranlarda 3 slayt göster
    spaceBetween: 30, // Slaytlar arasında 30 piksel boşluk bırak
    navigation: {
        nextEl: '.swiper-button-next', // Sonraki düğme
        prevEl: '.swiper-button-prev', // Önceki düğme
    },
    // Küçük ekranlarda özellikleri güncelle
    breakpoints: {
        800: {
            slidesPerView: 1, // 800px ve altı ekranlarda 1 slayt göster
        }
    }
});